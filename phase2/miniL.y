...
%% 
  ...
  TERM: VAR {printf("TERM -> VAR\n");}| NUMBER {printf("TERM -> NUMBER\n");} | L_PAREN EXPRESSION R_PAREN {printf("TERM -> L_PAREN EXPRESSION R_PAREN\n");} |
        SUB VAR %prec UMINUS {printf("TERM -> SUB VAR %PREC UMINUS\n");} | SUB NUMBER %prec UMINUS {printf("TERM -> SUB NUMBER %PREC UMINUS\n");} | SUB L_PAREN EXPRESSION R_PAREN %prec UMINUS {printf("TERM -> SUB L_PAREN EXPRESSION R_PAREN %PREC UMINUS\n");} |
